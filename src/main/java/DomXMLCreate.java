...
public class DomXMLCreate {
    public static void main(String argv[]) {
        try {
            ...
            bookAuthor.appendChild(doc.createTextNode("Robert Kiyosaki"));
            book1.appendChild(bookAuthor);

            // book name element
            Element bookName = doc.createElement("name");
            bookName.appendChild(doc.createTextNode("Cel mai bogat om din babilon"));
            book1.appendChild(bookName);

            // publication date element
            Element publicationDate = doc.createElement("publicationDate");
            publicationDate.appendChild(doc.createTextNode("1989"));
            ...
            book2Author.appendChild(doc.createTextNode("Kiyosaki"));
            book2.appendChild(book2Author);

            // book name element
            Element book2Name = doc.createElement("name");
            book2Name.appendChild(doc.createTextNode("Cadranul Banilor"));
            book2.appendChild(book2Name);

            // publication date element
            Element publicationDate2 = doc.createElement("publicationDate");
            publicationDate2.appendChild(doc.createTextNode("2001"));
